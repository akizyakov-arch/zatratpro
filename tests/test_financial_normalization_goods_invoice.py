...
CASES_PATH = Path(__file__).with_name("golden").joinpath("goods_invoice_financial_cases.json")
...
class GoodsInvoiceFinancialNormalizationGoldenTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_goods_invoice_financial_golden_cases(self) -> None:
